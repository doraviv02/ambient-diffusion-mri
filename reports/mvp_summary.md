...
- `figures/mvp/recon_montage_2view.png`
- `figures/mvp/recon_montage_4view.png`

**Results tables (visualized)**

- `figures/mvp/results_2view.png`
- `figures/mvp/results_4view.png`

**Cross-experiment**

- `figures/mvp/effect_sizes_forest.png`
- `figures/mvp/budget_ladder.png`
- `figures/mvp/finetuning_vs_coverage.png`

**Acquisition design and tuning**

- `figures/mvp/mask_design_all.png`
- `figures/mvp/lss_tier_tuning.png`

**Supporting — absolute error maps**

- `figures/mvp/error_maps.png`
- `figures/mvp/error_maps_quad.png`
